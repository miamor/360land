...
$(document).ready(function() {
    ...
    $('.public-profile-link').attr('href', MAIN_URL + '/user/' + __userInfo.id);
    ...
    if (urls == '' || urls == '/') url = 'info';
    console.log(MAIN_URL + '/dashboard' + urll);
    $('.menu-one-item[href="' + MAIN_URL + '/dashboard' + urll + '"]').addClass('active');
})