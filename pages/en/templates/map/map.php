...
<div id="mapSide">
    <div class="controls-area" id="controlArea">
        ...
        <div class="fullscreen hidden">
            <img src="https://file4.batdongsan.com.vn/images/Product/Maps/full-screen.png" title="Fullscreen" />
            Fullscreen
        </div>
        <div class="exitfullscreen hidden">
            <img src="https://file4.batdongsan.com.vn/images/Product/Maps/exit-full-screen.png" title="Default view" />
            Default view
        </div>
    </div>
        ...
        <div class="tab-content map-search-tabs">
            <div class="tab-pane active" id="map_search">
                <ul class="nav nav-tabs map_search_select map-nav-select">
                    ...
                    <li attr-type="project"><a href="#map_search_project" data-toggle="tab">Projects</a></li>
                </ul>
            ...
            <div class="tab-pane hide" id="map_results">
                <ul class="nav nav-tabs map_results_select map-nav-select">
                    ...
                    <li><a href="#map_results_project" data-toggle="tab">Projects</a></li>
                </ul>
                <div class="tab-content map-results-tabs">
                    <div class="tab-pane active" id="map_results_node">
                        <div class="empty_results">No data.</div>
                    </div>
...
<div class="btn-map-update-result hidden">
    <span>Click to update newest results</span>
</div>
...
<div id="iw-container">
    ...
    <div class="iw-content map-item-info-details">
        ...
        <div class="map-item-info-more">
                <div title="Type"><i class="fa fa-building"></i> Type: <span class="map-item-info-type"></span></div>

                <div title="Bedrooms"><i class="fa fa-bed"></i> Bedrooms: <span class="map-item-info-bed"></span></div>
                <div title="Direction"><i class="fa fa-map-signs"></i> Direction: <span class="map-item-info-huong"></span></div>

                <div title="Contact"><i class="fa fa-phone"></i> Contact: <span class="map-item-info-contact_phone"></span> (<span class="map-item-info-contact_name"></span>)</div>
        </div>
...
<div class="v-place-view">
    <div class="v-place-imgs no-padding">
        ...
        <div class="v-place-switch-buttons">
            <div class="v-place-mode active" id="v-thumbs" title="Thumbnails"><i class="fa fa-picture-o"></i></div><div class="v-place-mode" id="v-360" title="360 view"><i class="fa fa-map"></i></div><div class="v-place-mode" id="v-video" title="Video"><i class="fa fa-play-circle"></i></div><div class="v-place-mode" id="v-streetview" title="Streetview"><i class="fa fa-map-signs"></i></div>
        </div>
    </div>
    <div class="v-place-switch-btns">
        <div class="v-place-mode" id="v-direction" title="Dẫn đường"><i class="fa fa-car"></i> Directions</div><div class="v-place-mode" id="v-util" title="Utilities"><i class="fa fa-cutlery"></i> Utilities</div><div class="v-place-mode v-mode-project" id="v-sales" title="Sales"><i class="fa fa-users"></i> Sales</div><div class="v-place-mode v-mode-project" id="v-tiendo" title="Tiến độ dự án"><i class="fa fa-spinner"></i> Tiến độ</div>
    </div>
    <div class="popup-section section-light v-place-info">
        ...
        <div class="v-box v-place-more">
            ...
            <ul class="v-box-content open">
                <li class="v-place-more-one v-place-area">Area: <span></span>m2</li>
                <li class="v-place-more-one v-place-direction">Direction: <span></span></li>
                <li class="v-place-more-one v-place-room">Bedrooms: <span></span></li>
                <li class="v-place-more-one v-place-type">Type: <span></span></li>
                <li class="v-place-more-one v-place-tiendo"></li>
            </ul>
        </div>

        <div class="v-box v-place-contact"><h4>Contact</h4>
            <ul class="v-place-more v-box-content open">
                <li><i class="fa fa-user"></i> Contact name: <span class="v-place-ten bold"></span></li>
                <li><i class="fa fa-phone"></i> Phone: <span class="v-place-phone bold"></span></li>
        ...
        <div class="v-box"><h4>Details </h4><div class="v-box-content"><div class="v-place-details"></div></div></div>
...
<div class="v-place-v-direction v-place-mode-board hide" attr-mode="direction">
    ...
    <form class="start_end_points">
        <div class="trip-from">
            <input data-tap-disabled="true" autocomplete="disabled" id="start" type="text" name="start" class="form-control" placeholder="From *"/>
        </div>
        <div class="trip-to">
            <input data-tap-disabled="true" disabled autocomplete="disabled" id="end_fake" class="form-control" type="text" name="end_fake" placeholder="To *"/>
            <input id="end" type="hidden" name="end"/>
        </div>
    </form>

    <div class="hidden">
      <a href="#" class="bigger-map left" title="Extend"><i class="fa fa-arrows-alt"></i></a>
