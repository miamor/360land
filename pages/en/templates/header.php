    ...
    <nav id="top_navbar" class="navbar navbar-toggleable-md navbar-static-top bg-inverse">
		...
		<ul class="nav navbar-nav">
			<li class="nav-item active">
				<a class="nav-link" href="<?php echo MAIN_URL ?>"><i class="fa fa-home"></i> Home <span class="sr-only">(current)</span></a>
			</li>
			<li class="nav-item add-node-link dropdown">
				...
				<ul class="dropdown-menu with-triangle pull-right">
					<li class="nodesell"><a href="<?php echo MAIN_URL ?>/dashboard/node?mode=new&type=node"><i class="fa fa-plus"></i> Sell</a></li>
					<li class="nodesearch"><a href="<?php echo MAIN_URL ?>/dashboard/node?mode=new&type=search"><i class="fa fa-plus"></i> Search</a></li>
				</ul>
			</li>
			<li class="nav-item nav-subscribe">
				<a class="nav-link" href="<?php echo MAIN_URL ?>/dashboard/subscribe"><i class="fa fa-heart"></i> Saved</a>
			</li>
			<li class="nav-item hidden">
				<a class="nav-link" href="<?php echo MAIN_URL ?>"><i class="fa fa-info-circle"></i> Thông tin sổ đỏ</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo MAIN_URL ?>/sale"><i class="fa fa-user"></i> Sales</a>
			</li>
			<li class="nav-item nav-manual">
				<a class="nav-link" href="<?php echo MAIN_URL ?>/manual"><i class="fa fa-book"></i> Manual</a>
			</li>
		...
		<div class="nav-user">
			<a class="hide" id="me_login_link" href="<?php echo MAIN_URL ?>/login">Login</a>
			<a class="hide" id="me_reg_link" href="<?php echo MAIN_URL ?>/register">Register</a>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu with-triangle pull-right">
						<li>
							...
							<div class="btn btn-primary btn-block btn-sm see-all-noti">View all</div>
						</li>
					</ul>
				</li>
			</ul>
