...
<div class="borderwrap form-reg-fb hide col-lg-6">
    <h4 class="page-title show">Create new account</h4>
    <form id="reg_fb">
...
<div class="borderwrap form-login col-lg-6">
    <form id="login" onsubmit="return submitLoginForm()">
        <h4 class="page-title show">Login</h4>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                ...
                <div style="margin-top:5px"><a class="forgetpassword" href="<?php echo MAIN_URL ?>/login?mode=forgetpassword">Forgot password?</a></div>
            </div>
            <div class="clearfix"></div>
        </div>
