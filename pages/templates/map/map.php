        ...
        <div class="tab-content map-search-tabs">
            <div class="tab-pane active" id="map_search">
                <ul class="nav nav-tabs map_search_select map-nav-select">
                    <li attr-type="node"><a href="#map_search_node" data-toggle="tab">Rao bán/cho thuê</a></li>
                    <li class="active" attr-type="project"><a href="#map_search_project" data-toggle="tab">Dự án</a></li>
                </ul>
            ...
            <div class="tab-pane hide" id="map_results">
                <ul class="nav nav-tabs map_results_select map-nav-select">
                    <li><a href="#map_results_node" data-toggle="tab">Rao bán/cho thuê</a></li>
                    <li class="active"><a href="#map_results_project" data-toggle="tab">Dự án</a></li>
                </ul>
                <div class="tab-content map-results-tabs">
                    <div class="tab-pane hide" id="map_results_node">
                        <div class="empty_results">Không có bất động sản nào.</div>
                    </div>
                    <div class="tab-pane active" id="map_results_project">
