...
<div class="form-reg-fb hide col-lg-10">
    <h4 class="with-border page-title show">Đăng ký tài khoản</h4>
    <form id="reg_fb">
...
<div class="form-login col-lg-10">
...
<div class="col-lg-4 social-login">
