<form id="theform" class="place-add">
    <div class="add-form-content">
        ...
        <div class="txt-with-line center">
            <span class="txt generate-new-button">Thông tin chi tiết <span class="fa fa-caret-down"></span></span>
        </div>
        ...
        <div class="form-group" attr-required="1">
            <div class="col-lg-3 no-padding control-label">Mô tả chi tiết </div>
            <div class="col-lg-9 no-padding">
        ...
        <div class="txt-with-line center toggle-more">
            <span class="txt generate-new-button">Thông tin thêm (không bắt buộc) <span class="fa fa-caret-up"></span></span>
        </div>
        <div class="open-more">
