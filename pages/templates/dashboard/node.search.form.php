    ...
    <div class="add-form-content">
        ...
        <div class="form-group form-adr" attr-required="1">
            ...
            <div class="col-md-8 no-padding">
                ...
                <div class="form-group map_select hide">
        ...
        <div class="txt-with-line center toggle-more">
            <span class="txt generate-new-button">Thông tin thêm (không bắt buộc) <span class="fa fa-caret-down"></span></span>
        </div>
        <div class="open-more hide">

            <div class="form-group hide customshow typereal11 typereal1 typereal4">
            ...
            <div class="form-group hide customshow typereal1 typereal11 typereal2 typereal3 typereal4">
            ...
            <div class="form-group hide customshow typereal2 typereal3 typereal4">
